...
requires 'ElasticSearchX::Model::Document';
requires 'ElasticSearchX::Model::Document::Set';
requires 'ElasticSearchX::Model::Document::Types';
requires 'ElasticSearchX::Model::Util';
...
requires 'MooseX::Types::ElasticSearch';
